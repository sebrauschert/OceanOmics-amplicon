...
blastdbcmd -info -db databases/12S.v0.9.16S.v0.3.Mitogenomes.v0.1.fasta  > logs/06-run_blast_ocom_database_information.log
...
blastn -db databases/12S.v0.9.16S.v0.3.Mitogenomes.v0.1.fasta \
